...
public class PurchaseDateDTO {
	...
	public PurchaseDateDTO() {
		super();
		// TODO Auto-generated constructor stub
	}

	public PurchaseDateDTO(Integer purchase_id, String member_id, Timestamp purchase_date, Integer delivery_id,
			int purchase_amount, Integer purchase_delivery_fee, Integer purchase_used_point, Integer purchase_coupon,
			Integer purchase_payment, String purchase_method, String member_username, int selectDate) {
		super();
