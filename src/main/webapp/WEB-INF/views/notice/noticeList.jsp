							...
							<div class="card-body py-3 "
								...
								<div class="row no-gutters align-items-center"
									...
									<div class="col-2 d-none d-md-block" align=center
										style="padding-left: 0px !important;">${notices.notice_id }</div>
									<%-- 웹버전 title --%>
									<div class="col-4 d-none d-md-block" align=left>
										<a
											href="/notice/detail?notice_id=${notices.notice_id}&member_id=${notices.member_id}&cPage=${cPage}"
							...
							<div class="col-3" style="text-align: right;">
								...
								<script>
									...
									let searchEvent = function() {
										...
										location.href = "/notice/search?cPage=1&select="
												+ select
												+ "&keyword="
												+ keyword;
									};
