...
public class NoticeService {
	...
	public String getPageNavi(int currentPage) {
		...
		String pageNavi = "";
		if(needPrev) {pageNavi += "<a href='/notice/toNotice?cpage="+(startNavi-1)+"'><</a> ";}
		for(int i = startNavi; i <= endNavi; i++) {
			pageNavi += "<a href='/notice/toNotice?cpage="+i+"'>" + i + "</a> ";
		}
		if(needNext) {pageNavi += "<a href='/notice/toNotice?cpage="+(endNavi-1)+"'>></a>";}
