...
import kh.spring.dto.request.RequestLink;
import kh.spring.dto.request.SubscribeBilling;
import kh.spring.dto.request.SubscribeBillingReserve;
import kh.spring.dto.request.Token;
import kh.spring.dto.request.User;
import kh.spring.dto.response.ResToken;
...
//     private final String URL_REMOTE_FORM = BASE_URL + "app/rest/remote_form.json";
    ...
    public BootpayApiDTO() {}
    public BootpayApiDTO(String rest_application_id, String private_key) {
