			...
			<form action="/done.board" method="post" id="frm">
				<div class="container mb-4 mt-4">
					<div class="row" style="padding-bottom: 5px;">
						<div class="col-sm-12">
							<input hidden="hidden" /> <input type=text id=input-title
								name=title placeholder="제목을 작성하세요" style="width: 100%;">
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
			...
			if(maxCnt > 0) {
				$(document).ready(function() { //글 1000글자 입력 제한 코드
		 		    $('.note-editable').on('keyup', function() { //글 1000글자 입력 제한 코드
		 		        $('.contentCnt').html("(" + textCnt +" / 1000)");
// 		 		       if(textCnt > 1000) {
// 		 		    	  $('.note-editable').htm(editorText.substring(0, 1000));
